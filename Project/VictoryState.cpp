...
//定数の初期化
const DirectX::SimpleMath::Vector3 VictoryState::APPLE_POS   = DirectX::SimpleMath::Vector3(290.0f, 300.0f, 0.0f);
const DirectX::SimpleMath::Vector3 VictoryState::ANIMAL_POS  = DirectX::SimpleMath::Vector3(50.0f, 300.0f, 0.0f);
const DirectX::SimpleMath::Vector3 VictoryState::SCORE_POS   = DirectX::SimpleMath::Vector3(650.0f, 330.0f, 0.0f);
const DirectX::SimpleMath::Vector3 VictoryState::MESSAGE_POS = DirectX::SimpleMath::Vector3(-0.0f, -0.6f, 0.0f);
const float						   VictoryState::SCORE_SIZE  = 5.0f;
const float						   VictoryState::ANIMAL_SIZE = 0.3f;
const float						   VictoryState::APPLE_SIZE  = 0.3f;
...
void VictoryState::Initialize()
{
	...
	//画像の作成
	this->m_victory = std::make_unique<Batch>("Victory");
...
//描画
void VictoryState::Render(const DirectX::SimpleMath::Matrix& proj)
{
